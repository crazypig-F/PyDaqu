...
bacteria <- read.csv("../../../data/raw/Daqu bacteria asv.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
fungi <- read.csv("../../../data/raw/Daqu fungi asv.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
write.csv(alpha, "./data/result/diversity/alpha.csv")
