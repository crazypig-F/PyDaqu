...
data <- read.table("./data/temp/source/bacteria_mechanical_source_contributions_matrix.txt")
...
ggsave(filename = "./pdf/source/bacteria_mechanical_sources.pdf", g, width = 10, height = 6, dpi = 600, units = "cm", device = 'pdf')
