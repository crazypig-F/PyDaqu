...
data <- read.table("./data/temp/source/fungi_tradictional_source_contributions_matrix.txt")
...
ggsave(filename = "./pdf/source/fungi_tradictional_sources.pdf", g, width = 10, height = 6, dpi = 600, units = "cm", device = 'pdf')
