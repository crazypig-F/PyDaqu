...
P <- read.csv("./data/temp/amino/chamber/mean/traditional.csv", header = TRUE, row.names = 1, check.names = FALSE)
...
ggsave(filename = "./pdf/mantel/microbe_amino/tradictional.pdf", g, width = 20, height = 18, dpi = 600, units = "cm", device = 'pdf')
