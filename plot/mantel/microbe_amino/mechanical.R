...
library(scales)
source("./plot/font.R")
M <- read.csv("./data/temp/microbe/chamber/merge/top/mechanical.csv", header = TRUE, row.names = 1, check.names = FALSE)
P <- read.csv("./data/temp/amino/chamber/mean/mechanical.csv", header = TRUE, row.names = 1, check.names = FALSE)
...
ggsave(filename = "./pdf/mantel/microbe_amino/mechanical.pdf", g, width = 20, height = 18, dpi = 600, units = "cm", device = 'pdf')
