...
bacteria <- read.csv("./data/temp/abundance/bacteria/traditional.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
ggsave(filename = "./pdf/abundance/bacteria/legend.pdf", g, width = 30, height = 50, dpi = 600, units = "cm", device = 'pdf')
