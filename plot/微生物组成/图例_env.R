...
bacteria <- read.csv("./data/temp/abundance/bacteria_env/traditional.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
ggsave(filename = "./pdf/abundance/bacteria_env/legend.pdf", g, width = 30, height = 50, dpi = 600, units = "cm", device = 'pdf')
