...
merge <- read.csv("./data/temp/microbe/chamber/merge/top/mechanical.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
amino <- read.csv("./data/temp/amino/chamber/mean/mechanical.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
pdf("./pdf/corr/microbe_amino_mechanical.pdf", width = 20, height = 10, family = "sans")
corrplot(corr,
         method = "ellipse",
         col = mycol(100),
         outline = 'grey',
