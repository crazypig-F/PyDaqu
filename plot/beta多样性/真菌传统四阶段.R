...
data <- read.csv("./data/temp/beta/fungi/traditional.csv", header = TRUE, row.names = 1, encoding = "UTF-8", check.names = FALSE)
...
ggsave(filename = "./pdf/beta/fungi/traditional.pdf", g, width = 9, height = 8, dpi = 600, units = "cm", device = 'pdf')
